  ...
  return ({
    ...
    toBeA: function (expected) {
      if (actual.constructor.name == expected) {
        logSuccess(`Test Passed, ${actual} is a ${expected}`)
      } else {
        logFail(`Test Failed, ${actual} is not a ${expected}`)
      }
    },
    notToBeA: function (expected) {
      if (actual.constructor.name == expected) {
        logSuccess(`Test Passed, ${actual} is not a ${expected}`)
      } else {
        logFail(`Test Failed, ${actual} is a ${expected}`)
      }
    },
    toBeTrue: function() {
      if (actual === true) {
